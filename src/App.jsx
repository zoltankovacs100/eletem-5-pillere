...
function App() {
  ...
  return (
    ...
    <div ref={exportRef} className="w-full min-h-screen bg-gradient-to-br from-gray-950 to-gray-700 text-white px-0 py-10 overflow-x-hidden justify-center items-center flex flex-col">
